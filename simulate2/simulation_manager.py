...
if __name__ == "__main__":
    ...
    if not hasattr(cfg, 'stage1'):
        from config import ConfigNamespace # Assuming ConfigNamespace is in config.py
        cfg.stage1 = ConfigNamespace({'num_simulations': 10, 'num_particles': 50, 'timesteps': 1000})
    ...
    if not hasattr(cfg, 'stage2'):
        ...
        cfg.stage2 = ConfigNamespace({'num_halos': 10, 'num_particles': 100, 'halo_radius_pc': 10, 'timesteps': 1000})
