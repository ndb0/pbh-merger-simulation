...
if __name__ == "__main__":
    ...
    # --- Parameters for the grid(s) you want to compute ---
    # We will compute files for ALL pairs and f_pbh values needed by unequal.py
    ...
    a_min_grid = 5e-5
    a_max_grid = 0.1 # Use a single reasonable a_max for all
    j_min_grid = 1e-6
    j_max_grid = 1.0
    
    # --- Loop over all parameter sets and precompute all necessary files ---
